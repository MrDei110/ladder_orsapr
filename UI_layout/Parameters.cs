...
namespace LadderPlugin
{
    ...
    public class Parameters
    {
        ...
        private void ValidateParameters()
        {
            ...
            if (parameterType == ParameterType.TotalHeight)
            {
            ...
            if (parameterType == ParameterType.StepsAmount)
            {
                if (this.AllParameters.TryGetValue(
            ...
            else if (parameterType == ParameterType.StepsSpacing)
            {
                if (this.AllParameters.TryGetValue(
                        ParameterType.TotalHeight,
                        out chainedParameterFirst) == true &&
            ...
            else if (parameterType == ParameterType.MaterialThickness)
            {
                if (this.AllParameters.TryGetValue(
                        ParameterType.TotalHeight,
                        out chainedParameterFirst) == true &&
